...
public class RequestAdapter extends RecyclerView.Adapter<RequestAdapter.ViewHolder> {
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.delete:
                        ...
                        }).doRequestForRemoveNotificaitonUser(dataItem.get((dataItem.size()-1)-(getAdapterPosition())).getId(),"");

                        dataItem.remove((dataItem.get((dataItem.size()-1)-(getAdapterPosition()))));
    ...
    public RequestAdapter(ArrayList<Notification> dataItem) {
        this.dataItem = dataItem;
    }

    public RequestAdapter(ArrayList<Notification> dataItem, Context context) {
    ...
    public RequestAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_request, null);
        RequestAdapter.ViewHolder viewHolder = new RequestAdapter.ViewHolder(itemLayoutView);
        return viewHolder;
    }
